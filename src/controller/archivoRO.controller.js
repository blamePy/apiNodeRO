...
const getArchivo = async (req, res) => {
    try {        
        ...
        //tarjeta
        const resultTar = await connection.execute("SELECT t.item,to_char(t.fechaoperacion, 'dd-mm-yyyy hh24:mi:ss') fechaoperacion,t.sucursal,t.numerotarjeta,t.codinstrumento,t.nombretitular,t.numerodocumento,t.tipodocumento,t.montooperaciongs,t.lineacredito FROM prm.tarjeta t");
